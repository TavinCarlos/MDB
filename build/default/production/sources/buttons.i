...
# 8 "sources/buttons.c" 2
# 21 "sources/buttons.c"
volatile _Bool BtnA0_Event;
volatile _Bool BtnA1_Event;
volatile _Bool BtnA2_Event;

volatile _Bool BtnD0_Event;
volatile _Bool BtnD1_Event;
volatile _Bool BtnD2_Event;

volatile _Bool BtnD0_LongEvent;



static _Bool rA0_last, rA1_last, rA2_last;
static _Bool rD0_last, rD1_last, rD2_last;

static _Bool btnA0_lock, btnA1_lock, btnA2_lock;
static _Bool btnD0_lock, btnD1_lock, btnD2_lock;

static _Bool rd1_pressed;
static _Bool rd2_pressed;
...
void Buttons_Init(void) {
    ...
    rA0_last = PORTAbits.RA0;
    rA1_last = PORTAbits.RA1;
    rA2_last = PORTAbits.RA2;

    rD0_last = PORTDbits.RD0;
    rD1_last = PORTDbits.RD1;
    rD2_last = PORTDbits.RD2;
