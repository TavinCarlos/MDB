...
# 4 "sources/LCD_Hal.c" 2
# 15 "sources/LCD_Hal.c"
...
{
    LATBbits.LATB4 = (n >> 0) & 1;
    LATBbits.LATB5 = (n >> 1) & 1;
    LATBbits.LATB6 = (n >> 2) & 1;
    LATBbits.LATB7 = (n >> 3) & 1;
    LCD_PulseEN();
}
...
void LCD_HAL_Init(void)
{
    ...
    LCD_HAL_SendCommand(0x28);
    LCD_HAL_SendCommand(0x0C);
    LCD_HAL_SendCommand(0x06);
    LCD_HAL_SendCommand(0x01);
