...
# 10 "sources/MDB_Core.c" 2
# 21 "sources/MDB_Core.c"
...
void MDB_Core_Task(void)
{
    while (UART_Helper_BytesAvailable())
    {
        ...
        TimerNB_Start(&tmr_mdb_interbyte, 10);
